<template>
  ...
  <div>
    <Modal v-if="propsData.puzzleShowModal" @close="closePopup">
      <template v-slot:body>
        <div class="math-modal puzzle">
          <div class="modal-top">
            <h1 class="title">숫자 퍼즐</h1>
            <button @click="closePopup" class="math-modal-close"></button>
          </div>
          <div class="contents">
            <div class="play-img">
              <img src="@/assets/img/launcher/play-math/playtype-info-01@3x.webp" alt="">
            </div>
            <div class="choice-level total3">
              <div class="level-btn">
                <button class="level1" @click="openViewer(181, 18001, 'SL_18001_0')"></button>
                <button class="level2" @click="openViewer(181, 18002, 'SL_18002_0')"></button>
                <button class="level3" @click="openViewer(181, 18003, 'SL_18003_0')"></button>
              </div>
              <ul class="level-info">
                <li class="age2">5세 권장</li>
                <li>6~7세 권장</li>
              </ul>
            </div>
          </div>
