<template>
  ...
  <div>
    <Modal v-if="propsData.miroShowModal" @close="closePopup">
      <template v-slot:body>
        <div class="math-modal miro">
          <div class="modal-top">
            <h1 class="title">숫자 미로</h1>
            <button @click="closePopup" class="math-modal-close"></button>
          </div>
          <div class="contents">
            <div class="play-img">
              <img src="@/assets/img/launcher/play-math/playtype-info-05@3x.webp" alt="">
            </div>
            <div class="choice-level total3">
              <div class="level-btn">
                <button class="level1" @click="openViewer(181, 18012, 'SL_18012_0')"></button>
                <button class="level2" @click="openViewer(181, 18013, 'SL_18013_0')"></button>
                <button class="level3" @click="openViewer(181, 18014, 'SL_18014_0')"></button>
              </div>
              <ul class="level-info">
                <li>5세 권장</li>
                <li>6세 권장</li>
